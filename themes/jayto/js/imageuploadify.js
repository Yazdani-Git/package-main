    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <span class='imageuploadify-message'>فایل ها را برای آپلود اینجا بکشید</span>
          <button type="button" class="btn btn-default">یا فایل را از اینجا انتخاب کنید.</button>
        </div>
      </div>
      `);
