...
// delete_user_meta($user_id,'jayto-wallet');
    ...
    <div class="profile_box">
                ...
                <span class="prb_menu_item ">
                    ...
                    <div class="prb_menu_section">
                        ...
                        <div class="prb_menu_section">
                            ...
                            <a href="<?php echo home_url(); ?>/wallet" class="prb_menu_item active">
        ...
        <div class="prb_content">
            <div class="mh_head_back">
                <p class="acount_ht fz16 fw700 ">کیف پول</p>
				<?php
				if ( wp_is_mobile() ) { ?>
            ...
            <div class="prb_content_body">
                <div class="prb_wallet d_flex padd20">
                    <div class="prbcb_right width55">
                        <p class="fz15 fw700">افزایش موجودی کیف پول</p>
                        <p class="fz11 fw300 col_gray mbt15">با شارژ موجودی حساب خود می‌توانید با سرعت و سهولت بیشتری خرید کنید.</p>
                        ...
                        <form action="<?php echo get_template_directory_uri() . '/payment/' . $bank_name . '/request.php' ?>" name="up_wallet" class="up_wallet" method="post">
                            <div class="wallet_inp_box">
                                ...
                                <input type="hidden" name="uid" autocomplete="off"  value="<?php  echo get_current_user_id()?>">
                                <span class="fz11 fw300 mr5">تومان</span>
                            </div>
                            <span class="wallet_submit">افزایش موجودی</span>
                        </form>
                    ...
                    <div class="prbcb_left width45 d_flex">
                        <div class="wallet_cart">
                            ...
                            <div class="wallet_footer">
                                ...
                                <div>
									<?php
									$amount = get_user_meta( $user_id, 'jayto-wallet' );
									if ( $amount ) {
										$amount_ex = $amount[0];
									} else {
										$amount_ex = 0;
