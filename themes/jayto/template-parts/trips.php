    ...
    <div class="profile_box">
		...
		if ( ! wp_is_mobile() ) {
            ...
            <div class="prb_content">
				...
				<?php
				$orders = get_user_trips( $user_role );
                                ...
                                <div class="trips_item">
                                    <div class="tri_right">
                                        <div class="tritop">
                                            ...
                                            <div class="trit_left">
                                                <div class="tritl_t">
                                                    ...
                                                    <span class="rqpc_title"><?php echo $this_room['room_name'] ?></span>
                                                    <div class="fl_div">
                                                        <span class="fw300 fz13">تعداد مهمان</span>
                                                        <span class="fz13"> <?php echo $order->passenger_number ?> &nbsp;نفر</span>
                                                    </div>
                                                    <div class="tritl_b">
                                        ...
                                        <div class="tribot">
											...
											if ( $order->author_id == $cuser && $order->order_status == 10 ) {
                                    ...
                                    <div class="tri_left">
										...
										if ( $order->order_status == 10 ) { ?>
                                            <div class="adition_toption">
                                                ...
                                                <div class="adito_drop">
	                                                ...
	                                                if ( $hotel_room_old != '' ) {
		                                                ?>
                                                        <a class="vach_link" target="_blank" href="<?php echo home_url() ?>/voucher?vid=<?php echo $order->id + 25 ?> " >مشاهده واچر</a>
										...
										<?php if ( $timer_pay > 0 && $order_status == 4 ) {
                                            ...
                                            <div class="trppb">
												...
												if ( $order->room_id ) {
													$dash_check_in  = change_date_dash_to_slash( $order->check_in );
													$dash_check_out = change_date_dash_to_slash( $order->check_out );


													?>
                                                    <a class="trip_pay "
                                                       href="<?php echo home_url() ?>/hotel-request/?hoi=<?php echo $order->res_id ?>&check_in=<?php echo $dash_check_in ?>&check_out=<?php echo $dash_check_out ?>&pass_num=<?php echo $order->passenger_number ?>&pci=<?php echo $order->price ?>&roid=<?php echo $order->room_id ?>&child=<?php echo $order->child_number ?>&adult_num=<?php echo $order->adult_number ?>">در
                                                        انتظار پرداخت
                                                        &nbsp;<span class="resend_timer_elm"></span></a>
												<?php } else { ?>
                                                    <a class="trip_pay " href="<?php echo home_url() ?>/request/?res_id=<?php echo $order->res_id ?>&check_in=<?php echo $order->check_in ?>&checkout=<?php echo $order->check_out ?>&pass_num=<?php echo $order->passenger_number ?>">در انتظار پرداخت
                                                        &nbsp;<span class="resend_timer_elm"></span></a>
												<?php }
                                            ...
                                            <script>
                                                jQuery('.resend_timer_elm').backward_timer({
                                                    ...
                                                    on_exhausted: function ($timer_pay) {
                                                        ...
                                                        jQuery('.trppb').html('<div class="trb_pay_but pay_dis"> <span>رد شده سیستمی</span> &nbsp; </div>')
                                                    ...
                                                    <script>
                                                        jQuery('.wait_timer_elm').backward_timer({
                                                            ...
                                                            on_exhausted: function ($timer_pay) {
                                                                ...
                                                                jQuery('.trb_wait_but').html('<div class="trb_pay_but pay_dis"> <span>رد شده سیستمی</span> &nbsp; </div>')
                                    ...
                                    <div class="trips_item">
                                        <div class="tri_right">
                                            ...
                                            <div class="tribot">
												...
												<?php }else{ ?>
                                                    <div class="trib_date">
                                                        <span class="fw700 mbt10 fz14">مشخصات مهمان</span>
                                                        <span class="mbt10 fz13">&nbsp;نام : <?php echo $guest_info->passenger_name ?></span>
                                                        <span class="mbt10 fz13"> &nbsp;  نام خانوادگی : <?php echo $guest_info->passenger_famili ?></span>
                                                        <span class="mbt10 fz13"> &nbsp; موبایل : <?php echo $guest_info->passenger_phone ?></span>
                                                    </div>
