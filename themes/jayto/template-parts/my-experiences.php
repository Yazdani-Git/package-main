		...
		<div class="prb_content">
			...
			if ( $residence ) {
				foreach ( $residence as $row ) {
					...
					$meta  = get_post_meta( $row->ID, 'all_tour_meta', 'true' );
					...
					<div class="prb_content_body">
						<div class="trips_item">
								...
								<div class="tritop">
									...
									<div class="trit_left">
										<div class="tritl_t">
											...
											<?php }
											?>
											<div class="mbt15"><span class="mr10 fw300 fz13">قیمت هر نفر </span><span class="mr10 ml_10 fw300 fz13"><?php echo number_format( $meta['tour_price'] ) ?>&nbsp; تومان</span></div>
							...
							<div class="tri_left_v ">
                                ...
                                <div class="sans_box">
                                    <a href="<?php echo home_url() . '/experiences-edit?ri=' . $row->ID; ?>"> <span class="host_edit_btn"><i class="fa fa-edit ml_10 col_blue"></i>ویرایش</span></a>
                                    <a href="<?php echo home_url() . '/experiences-add-sans?ri=' . $row->ID; ?>"> <span class="host_edit_btn"><i class="fa fa-plus ml_10 col_blue"></i>افزودن سانس</span></a>
                                </div>
