    ...
    <div class="profile_box">
          ...
          ?>
                ...
                <span class="prb_menu_item ">
					...
					if ( $user_role != 'host' ) {
						?>
                        <div class="prb_menu_section">
                            <p class="fz12 fw700 col_gray mbt10">میزبانی اقامتگاه</p>
                            <a href="#" class="prb_menu_item">
                                <span class="prb_icon"><i class="fa fa-exchange "></i></span>
                                <div class="prb_menu_container">
                                    <span class="fz11 fw500 col_gray2">میزبان شوید</span>
        ...
        <div class="prb_content">
            <div class="mh_head_back">
                <p class="acount_ht fz16 fw700 ">هتل های من</p>
				<?php
				if ( wp_is_mobile() ) { ?>
			...
			if ( $residence ) {
                    ...
                    <div class="prb_content_body">
                        <div class="trips_item">
                            <div class="tri_right">
                                ...
                                <div class="tribot">
									...
									if ( $row->post_status == 'failed' ) { ?>
                                        <i class="fa-regular fa-circle-bolt"></i>&nbsp;<span>دلایل رد هتل </span>
                                        <div class="not_boxe">
                            ...
                            <div class="tri_left_v ">
								...
								?>
                                <div class="lvnot">
                                    <span class="res_sts_ti">&nbsp;&nbsp;وضعیت هتل :</span><span class="res_sts">&nbsp;<?php echo $ps ?></span>


                                </div>
                                <div class="d_flex">
                                    <a href="<?php echo home_url() . '/hotel-edit?ri=' . $row->ID; ?>"> <span class="hotel_edit_btn"><i class="fa fa-edit ml_10 col_blue"></i>ویرایش</span></a>
                                    <a href="<?php echo home_url() . '/hotel-rooms-edit?ri=' . $row->ID; ?>"> <span class="room_edit_btn"> <i class="fa fa-thin  fa-plus ml_10 col_blue"></i>افزودن و ویرایش اتاق</span></a>
                ...
                <div class="no_item">
                    <span>هنوز هتلی ثبت نکرده اید.</span>
