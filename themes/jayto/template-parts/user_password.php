	...
	<div class="profile_box">
			 ...
			 <span class="prb_menu_item ">
                ...
                <span class="prb_menu_item ">
                    ...
                    <div class="prb_menu_section">
                        ...
                        <a href="<?php echo home_url() ?>/password" class="prb_menu_item active">
		...
		<div class="prb_content">
            <div class="mh_head_back">
                <p class="acount_ht fz16 fw700 ">رمز عبور</p>
	            <?php
	            if (wp_is_mobile()){ ?>
			...
			<div class="prb_content_body">
                <div class="input_pass_box">
                    <span class="ip_title">رمز عبور فعلی</span>
                    <input type="text" autocomplete="off" class="inp_old_pass" placeholder="رمز عبور فعلی خود را وارد کنید.">

                </div>
                <div class="oup_error chpass_err"></div>
                <span class="line90"></span>
                <div class="input_pass_box">
                    <span class="ip_title">رمز عبور جدید</span>
                    <input type="text" class="inp_new_pass" autocomplete="off" placeholder="رمز عبور جدید با حداقل 8 کاراکتر و ترکیبی از حروف و اعداد باشد.">

                </div>
                <div class="nup_error chpass_err"></div>
                <span class="line_dash90"></span>
                <div class="input_pass_box">
                    <span class="ip_title">تکرار رمز عبور</span>
                    <input type="text" class="renew_pass" autocomplete="off" placeholder="رمز عبور جدید را دوباره وارد کنید.">

                </div>
                <div class="rnup_error chpass_err"></div>
                <span class="line"></span>
                <div class="cop_err chpass_er"></div>
                <span class="change_pass_submit">ذخیره</span>
			</div>
		</div>
