...
class Calendar_desktop2
{
	...
	public function __toString()
	{
		...
		$html .= '<div class="np_calender">';
        $html .= '<span class="cal_desk_prev ' . $disable . '" data-priod=0 data-cdtj=' . $milady_day . ' data-pid=' . $this->post_id . '> &#8249; </span>';
		$html .= '<span class="month-year-text">' . jdate('F Y', strtotime($this->active_year . '-' . $this->active_month . '-' . $this->active_day), '', '', 'fa') . '</span>';
        $html .= '<span class="cal_desk_next" data-priod=0 data-cdtj=' . $milady_day . ' data-pid=' . $this->post_id . '> &#8250; </span>';
		$html .= '</div>';
		$html .= '</div>';
		$html .= '</div>';
		$html .= '<div class="days">';
