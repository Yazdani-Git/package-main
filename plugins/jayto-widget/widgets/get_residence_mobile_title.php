...
class get_residence_mobile_title extends \Elementor\Widget_Base {
    public function get_name() {
        return 'residence_mobile_title';
    }

    public function get_title() {
        return ' نام اقامتگاه موبایل';
    }
    ...
    \Elementor\Plugin::instance()->widgets_manager->register( new get_residence_mobile_title() );
